...
<body>
    ...
    <section class="parallax_window_in" data-parallax="scroll" data-image-src="<?=base_url('assets/')?>gambar/slide-2.jpg" data-natural-width="1400" data-natural-height="720">
        <div id="sub_content_in">
            <h1 style="text-transform:none"> - INFORMASI -  <strong id="js-rotating" style="text-transform:uppercase"></strong></h1>
            <p>SIMPLE KESRAWAN</p>
        </div>
    </section>
    <!-- End Header =============================================== -->
        ...
        <div class="row">
            ...
            <div class="col-md-9">
              <?php 
                    ...
                    <div class="img_wrapper">
                        <div class="img_container">
                            ...
                            <div class="short_info">
                                ...
                                <div class="score_wp">
                                    <?= $dt->kategoriNama?><div id="score_5" class="score" data-value="7.5"></div>
                                </div>
                            </div>
                            </a>
                        </div>
                ...
                <?php else:?>
                <b>Informasi yang anda cari tidak ditemukan !</b>
                <?php endif;?>
            </div>
