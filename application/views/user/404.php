...
<body>
    ...
    <section class="welcome-area">
        <div class="welcome-slides owl-carousel">
            ...
            style="background-image: url('<?=site_url('assets/gambar/');?>slide-2.jpg');">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <!-- Welcome Text -->
                        <div class="col-12 col-lg-8 col-xl-6">
                            <div class="welcome-text">
                                <h2 data-animation="bounceInUp" data-delay="100ms">404 <br>Not Found</h2>
                                <p data-animation="bounceInDown" data-delay="500ms">Fitur ini masih dalam tahap Pengembangan.</p>
                                <div class="hero-btn-group" data-animation="bounceInDown" data-delay="100ms">
                                    <a href="<?=site_url('beranda');?>" class="btn alime-btn mb-3 mb-sm-0 mr-4">KEMBALI KE BERANDA </a>
                                </div>
                            </div>
                        </div>
                    </div>
