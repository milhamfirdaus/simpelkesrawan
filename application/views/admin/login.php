            ...
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform">
                    	<h2 class="text-center"><b>Login Puskeswan</b></h2>
                    	<br/>
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" type="text" name="adminUsername" required="" placeholder="Username"> 
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                        ...
                        <div class="form-group text-center">
                            <div class="col-xs-12 p-b-20">
                                <button class="btn btn-block btn-lg btn-primary" type="submit">Masuk</button>
                            </div>
                        </div>
                         </div>
                        <div class="form-group text-center">
                            <div class="col-xs-12 p-b-20">
                                <a href="<?= site_url('beranda')?>">Kembali ke Beranda</a>
                                <p><?= NAMA_APLIKASI?></p>
                            </div>
                        </div>
                    </form>
